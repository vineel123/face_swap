...
#------------------------------------------------------------------------------
    def get_images(self):
        ...
        images = dict()
        images_dir = getattr(self.args, "input_a")
        num_of_faces = len(images_dir)

        for side in range(num_of_faces):
            image_dir = images_dir[side]
            ...
            images[str(side)] = get_image_paths(image_dir)
        logger.info("given Directories of model : %s", self.args.input_a)
...
#-----------------------------------------------------------------------------
    ...
    def load_model(self):
        ...
        model = PluginLoader.get_model(self.trainer_name)(
            ...
            predict=False,
            num_of_sides = len(self.args.input_a) #--------------------------------------------------------------------# 
            )
